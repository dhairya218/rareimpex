        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/products" className="text-gray-400 hover:text-green-400 transition-colors duration-300">
                  Our Products
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <span className="text-gray-400">Premium Apples</span>
              </li>
              <li>
                <span className="text-gray-400">Fresh Bananas</span>
              </li>
              <li>
                <span className="text-gray-400">Exotic Mangoes</span>
              </li>
              <li>
                <span className="text-gray-400">Citrus Fruits</span>
              </li>
            </ul>
          </div>
